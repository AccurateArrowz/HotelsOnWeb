...
import { User, Mail, Phone, Shield, LogOut, ArrowLeft, Edit3, LucideIcon } from 'lucide-react';
...
const ProfilePage = () => {
  ...
  const profileFields: ProfileField[] = [
    ...
    { label: 'Role', value: user.roleId?.toString(), icon: Shield },
  ];
            ...
            <div className="relative flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 -mt-12 sm:-mt-16">
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4">
                ...
                <div className="text-center sm:text-left sm:mb-2">
                  ...
                  <p className="text-gray-500 capitalize">Account</p>
                </div>
              </div>
