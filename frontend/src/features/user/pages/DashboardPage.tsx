...
import { useAuth, ProtectedRoute, RequirePermission, RoleBasedRender } from '@features/auth';
    ...
    <ProtectedRoute>
      <div className="dashboard-container">
        <div className="dashboard-header">
          <h1>Welcome, {(user as User)?.name}!</h1>
          <p className="user-role">Role: {(user as User)?.role}</p>
        </div>
