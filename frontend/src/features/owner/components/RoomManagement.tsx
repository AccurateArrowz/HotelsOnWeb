...
import { Room, RoomType } from '@hotelsonweb/shared';
...
import { useGetRoomTypesByHotelQuery } from '@features/owner/api';
...
const RoomManagement = ({ hotelId }: RoomManagementProps) => {
    ...
    return (
      <div className="room-management">
        <div className="error-state">
          <p>Error loading rooms: {(error as any).data?.message || 'Unknown error'}</p>
    ...
    <div className="room-management">
      ...
      <div className="room-stats-grid">
        {Object.entries(statusConfig).map(([key, cfg]) => {
          const count = (roomStats as any)[key] || 0;
          return (
